/*                                          Lab Task
Write a program using CLASS data structure for the following task: 
...
You are require to implement the following operation on the above student information: (your’ program should store at-least 10 or more student’s information) 

6.	Make a list of student with GPA less than 3.00
7.	Make a list of student with GPA more than 3
8.	Search for a particular student
9.	write a function which calculate student age
*/
#include <iostream>
#include <string>
using namespace std;
